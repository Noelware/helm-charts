# GitHub Bot - Helm Chart
This helm chart is to configure and run the **GitHub Bot** [Docker image](https://hub.docker.com/r/arisuland/github-bot)!
...
| **`image.repository`** | The repository to pull from | [`arisuland/github-bot`](https://hub.docker.com/r/arisuland/github-bot) |
